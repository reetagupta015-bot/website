...
export const Route = createFileRoute("/signup")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Create a Sheet.in account." },
    ],
  }),
    ...
    <div className="min-h-screen grid place-items-center bg-secondary/30 px-4 py-12">
      <div className="w-full max-w-md bg-card border border-border p-8 md:p-10">
        <div className="text-center mb-8">
          ...
          <h1 className="font-serif text-2xl mt-6">Create your account</h1>
          <p className="text-sm text-muted-foreground mt-1">Begin your journey in brilliance</p>
        </div>
        ...
        <p className="text-center text-sm text-muted-foreground mt-6">
          ...
          <Link to="/login" className="text-foreground underline hover:text-accent">Sign In</Link>
        </p>
      </div>
    </div>
  );
